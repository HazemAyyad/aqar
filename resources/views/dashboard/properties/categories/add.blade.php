                        ...
                        <div class="card-body">
                            <form id="mainAdd" method="post" action="javascript:void(0)" >
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" placeholder="{{__('Description')}}" >
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text"id="slug" name="slug" class="form-control"   aria-describedby="slug">
                                        </div>
                                    </div>
                                </div>
