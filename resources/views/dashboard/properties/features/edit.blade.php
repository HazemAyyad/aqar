                    ...
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$feature->name}}" placeholder="{{__('Name')}}" required>
                            </div>
                            <!-- Icons -->
                            <div class="col-md-6 mb-6">
                                ...
                                <select class="selectpicker w-100 show-tick" id="selectpickerIcons" name="category_id" data-icon-base="fa-solid"   data-style="btn-default">
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}" class="mb-2" {{$feature->category_id==$category->id?'selected':''}}>{{$category->name}}</option>
                                    @endforeach
