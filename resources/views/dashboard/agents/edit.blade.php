                    ...
                    <div class="card-body">
                        <form id="mainAdd" method="post" action="javascript:void(0)" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$agent->name}}" placeholder="{{__('Name')}}" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label" for="position">{{__('Position')}}</label>
                                <input type="text" class="form-control" name="position" id="position" value="{{$agent->position}}"  placeholder="{{__('Position')}}" required>
                            </div>
